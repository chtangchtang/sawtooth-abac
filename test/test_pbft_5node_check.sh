...
do
    ...
    do
        ...
        docker exec -it abac-client bash -c "cd test && abac add data/policy0.json --url rest-api-0:8008 && sleep 120 && python3 test_check_inquiry.py $rate rest-api-0:8008 && sleep 120"
...
tar -czvf /mnt/influxdb/output/pbft_5node_check.tar.gz /mnt/influxdb/output/pbft/5node/

...
for i in range(old_num, new_num):
    # abac-tp
    tmp = copy.copy(content['services']['abac-tp-python-0'])
    ...
    # validator
    tmp = copy.copy(content['services']['validator-' + str(i-1)])
    ...
    # rest-api
    tmp = copy.copy(content['services']['rest-api-0'])

...
sleep 30
docker exec -it abac-client bash -c "cd test && abac add data/policy0.json --url http://rest-api--0:8008 && sleep 30 && python3 test_check_inquiry.py 10 http://rest-api-0:8008"
sleep 30

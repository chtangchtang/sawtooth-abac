...
do
    ...
    do
        ...
        # Analyse results
        python3 /root/sawtooth-abac/analysis/calculate_time_add+delete.py /mnt/influxdb/output/raft/5node/add+delete_${rate}rate_${times} /root/raft_5node_result.csv
        # Down network
        docker-compose -f /root/sawtooth-abac/test/raft/5nodes.yaml down -v
    done
done
# Compress result files and remove them
tar -czvf /mnt/influxdb/output/raft_5node_add+delete.tar.gz /mnt/influxdb/output/raft/5node/
